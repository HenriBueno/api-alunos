...
CREATE TABLE "classroms" (
    ...
    CONSTRAINT "classroms_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Registrations" ADD CONSTRAINT "Registrations_classroom_id_fkey" FOREIGN KEY ("classroom_id") REFERENCES "classroms"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
